...
# loading models
DibetiesModel = pickle.load(open("DiabetesModel.sav",'rb'))
HeartModel =  pickle.load(open("HeartModel.sav",'rb'))
ParkinsonsModel =  pickle.load(open("ParkinsonsModel.sav",'rb'))
